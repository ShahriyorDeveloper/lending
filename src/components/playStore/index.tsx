    ...
    <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-8 mb-[120px]">
      <div className="bg-mainBoxRgb px-8 pt-8 rounded-[32px] h-[640px] flex flex-col justify-between max-sm:px-4 max-sm:pt-4 max-sm:h-[360px]">
        <div className="flex justify-between">
          ...
          <div className="w-[128px] ml-3 flex justify-center items-center h-[48px] text-[16px] leading-[48px] font-semibold rounded-[12px] border-[1px] border-main_button_color p-4 max-sm:w-[96px] max-sm:h-[36px] max-sm:text-[14px] max-sm:leading-5 max-sm:px-4">
      ...
      <div className="bg-mainBoxRgb px-8 pt-8 rounded-[32px] h-[640px] flex flex-col justify-between max-sm:px-4 max-sm:pt-4 max-sm:h-[360px]">
        <div className="flex justify-between">
          ...
          <div className="w-[128px] flex justify-center p-4 items-center h-[48px] text-[16px] leading-[48px] font-semibold rounded-[12px] border-[1px] border-main_button_color max-sm:w-[96px] max-sm:h-[36px] max-sm:text-[14px] max-sm:leading-5 max-sm:px-4">
            <Link href="/" className="text-nowrap">
              {t("download")}
            </Link>
            <Image className="ml-2" src={right} alt="right icon" />
          </div>
        </div>
        <div>
